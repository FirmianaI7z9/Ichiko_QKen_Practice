...
async function init() {
  ...
  if (id) {
    ...
    document.getElementById('user_data_detail').innerHTML = 
      '<nobr>累計解答問題数：<span style="font-size: 110%; font-weight: bold;">' + json.ans + '問</span> / <wbr/>'
      + '累計正解問題数：<span style="font-size: 110%; font-weight: bold;">' + json.cor + '問</span> / <wbr/>'
      + '正解率：<span style="font-size: 110%; font-weight: bold;">' + (Math.floor(json.rate * 100000) / 1000).toFixed(3) + '%</span></nobr>';
  } else {
